<?php
   ...
   {
    $editid=$_GET['edit'];
    $qry="select * from PaymentMethod where PMId=$editid";
...
<head>
     ...
     <meta charset="UTF-8" />
    <title>Expense Manager | Payment Method</title>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#tab1" data-toggle="tab">List Payment Method</a></li>
                                <li><a href="#tab2" data-toggle="tab">Add Payment Method</a></li>
                            </ul>           
                            <div class="tab-content">
                                <div id="tab1" class="<?php if(isset($ePMId)) {echo 'tab-pane fade';} else {echo 'tab-pane fade in active';}?>">
                                    <div class="table-responsive">
                                    <table class="table table-striped" id="tbl-paymentmethod">
                                        <thead>
                                        <tr>
                                        ...
                                        <tbody>
                                        <?php
                                            $sqry="select * from PaymentMethod";
                                            $rspaymentmethod=mysqli_query($con,$sqry);
                                            if(!$rspaymentmethod)
                                            {
                                            ...
                                            while($row=mysqli_fetch_assoc($rspaymentmethod))
                                            {
                                                ...
                                                echo "<td><a href='paymentmethod.php?edit=$row[PMId]' class='btn btn-info btn-circle'><i class='icon-check danger'></i></a></td>";
                                                echo "<td><a href='dbpaymentmethod.php?del=$row[PMId]' class='btn btn-danger btn-circle'><i class='icon-remove-sign'></i></a></td>";
                                                echo "</tr>";
                                            }
                                        }
                                        ?>
                                ...
                                <div id="tab2" class="<?php if(isset($ePMId)) {echo 'tab-pane fade  in active';} else {echo 'tab-pane fade';}?>">
                                    <form action="dbpaymentmethod.php" method="post" class="form-horizontal" id="popup-validation">
                                        <div class="form-group">
                                            <label class="control-label col-lg-4">Enter Payment Method Name</label>
                                            <div class="col-lg-4">
                                                <input type="text" class="validate[required] form-control" name="PMName" id="PMName" value="<?php if(isset($ePMName)) echo $ePMName;?>">
                                            </div>
                                            
                                        </div>
                                        <div style="text-align:center" class="form-actions no-margin-bottom">
                                                <input type="submit" value="<?php if(isset($ePMId)) {echo 'Save';} else {echo 'Insert';}?>" class="btn btn-primary btn-lg " name="btnsubmit" />
                                                <input type="reset" value="Clear" class="btn btn-primary btn-lg " />
                                                <input type="hidden" name="editid" value="<?php if(isset($ePMId)) echo $ePMId;?>" />
                                        </div>
                                    </form>
                                </div>
                            </div>
